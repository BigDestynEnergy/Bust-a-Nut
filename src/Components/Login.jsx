...
export default function LoginForm( {hide, setCuurentUser,setScreen,email, message, setMessage, password, setEmail, setPassword, setHide} ){
    ...
    return(
        <form onSubmit={(e)=>{e.preventDefault();
            ...
            <input type="email" value={email} placeholder="Enter your email" onChange={(e)=>{setEmail(e.target.value)}} />
             ...
             <hr />
             <div>Don't have an account? <i onClick={()=>setScreen('date')}>create new account</i></div>
        </form>
    )
}